    ...
    >
      ...
      >
        ...
        <h2 id='modal-title' className='text-2xl font-bold text-zinc-800 mb-2'>
          ...
          {source.startsWith('Brochure for') &&
            `${source}${context ? ` - ${context}` : ''}`}
          {source.startsWith('Booking Form') &&
            `${source}${context ? ` - ${context}` : ''}`}
          {source === 'Inquiry for' &&
            `Inquiry ${context ? ` - ${context}` : ''}`}
          {source === 'Inquiry for Service' &&
            `Inquiry ${context ? ` - ${context} Service` : ''}`}
        ...
        >
          ...
          {source === 'Downloading Brochure' &&
            `You're requesting a brochure${
              context ? ` for ${context}` : ''
            }. Please provide your details to receive it.`}
          {source.startsWith('Inquiry for Service')
            ? `You're inquiring about the ${context} plan. Let us know how we can assist you.`
            : source.startsWith('Inquiry for') &&
              `You're inquiring about the ${context} plan. Let us know how we can assist you.`}
          {source.startsWith('Brochure for') &&
            `You're requesting a brochure of the ${context} plan. Please provide your details to receive it.`}
          {source.startsWith('Booking Form') &&
            `You're scheduling a demo of the ${context} plan. Please fill out the form below to proceed.`}
          {source === 'Booking Form' &&
            `You're submitting an inquiry${
